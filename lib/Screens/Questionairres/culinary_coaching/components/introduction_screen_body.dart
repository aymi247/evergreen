  ...
  Widget build(BuildContext context) {
    ...
    return Background(
      child: Column(
        ...
        children: <Widget>[
          Text(
            "WELCOME TO CULINARY COACHING SESSION", 
            textAlign: TextAlign.center,
            style: TextStyle(fontWeight: FontWeight.bold, fontSize: 20,)
          ),
          MainSection(size: size, text: "This package will help you cook tasty and healthy meals!", image: "assets/images/culinary.png"),
