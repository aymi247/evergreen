  ...
  Widget build(BuildContext context) {
    ...
    return Background(
      child: Column(
        ...
        children: <Widget>[
          Text(
            "WELCOME TO 4-WEEK INTERMITTENT FASTING REGIME", 
            textAlign: TextAlign.center,
            style: TextStyle(fontWeight: FontWeight.bold, fontSize: 20,)
          ),
          MainSection(size: size, text: "This package will help you fast in a healthy manner!", image: "assets/images/stress.png"),
