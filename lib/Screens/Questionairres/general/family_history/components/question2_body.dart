      ...
      child: Column(
        ...
        children: <Widget>[
          ...
          Padding(
            ...
            child: MainSection(size: size, text: "Did your parents, grandparents, siblings or children suffer from Insomnia?", image: "assets/images/natural_supplements.jpg"),
          ),
...
Route _question3Route() {
  return PageRouteBuilder(
    pageBuilder: (context, animation, secondaryAnimation) => FamilyQuestion3Screen(),
