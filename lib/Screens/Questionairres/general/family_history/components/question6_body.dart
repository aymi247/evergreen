      ...
      child: Column(
        ...
        children: <Widget>[
          ...
          Padding(
            ...
            child: MainSection(size: size, text: "Did your parents, grandparents, siblings or children suffer from Arthritis?", image: "assets/images/natural_supplements.jpg"),
          ),
...
Route _question7Route() {
  return PageRouteBuilder(
    pageBuilder: (context, animation, secondaryAnimation) => FamilyQuestion7Screen(),
