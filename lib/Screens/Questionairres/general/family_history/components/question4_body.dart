      ...
      child: Column(
        ...
        children: <Widget>[
          ...
          Padding(
            ...
            child: MainSection(size: size, text: "Did your parents, grandparents, siblings or children suffer from Stroke?", image: "assets/images/natural_supplements.jpg"),
          ),
...
Route _question5Route() {
  return PageRouteBuilder(
    pageBuilder: (context, animation, secondaryAnimation) => FamilyQuestion5Screen(),
