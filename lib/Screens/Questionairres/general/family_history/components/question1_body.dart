      ...
      child: Column(
        ...
        children: <Widget>[
          ...
          Padding(
            ...
            child: MainSection(size: size, text: "Did your parents, grandparents, siblings or children suffer from High Cholester?", image: "assets/images/natural_supplements.jpg"),
          ),
...
Route _question2Route() {
  return PageRouteBuilder(
    pageBuilder: (context, animation, secondaryAnimation) => FamilyQuestion2Screen(),
