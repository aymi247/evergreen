      ...
      child: Column(
        ...
        children: <Widget>[
          ...
          Padding(
            ...
            child: MainSection(size: size, text: "Do you take Supplements (Natural products) daily?", image: "assets/images/natural_supplements.jpg"),
          ),
...
Route _question2Route() {
  return PageRouteBuilder(
    pageBuilder: (context, animation, secondaryAnimation) => CAMQuestion2Screen(),
