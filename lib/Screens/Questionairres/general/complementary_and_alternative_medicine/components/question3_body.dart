      ...
      child: Column(
        ...
        children: <Widget>[
          ...
          Padding(
            ...
            child: MainSection(size: size, text: "Traditional medicine (Alternate)?", image: "assets/images/natural_supplements.jpg"),
          ),
...
Route _question4Route() {
  return PageRouteBuilder(
    pageBuilder: (context, animation, secondaryAnimation) => CAMQuestion4Screen(),
