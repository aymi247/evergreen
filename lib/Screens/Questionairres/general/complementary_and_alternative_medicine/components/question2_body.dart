      ...
      child: Column(
        ...
        children: <Widget>[
          ...
          Padding(
            ...
            child: MainSection(size: size, text: "Meditation/Yoga/Prayer (Mind-body)?", image: "assets/images/natural_supplements.jpg"),
          ),
...
Route _question3Route() {
  return PageRouteBuilder(
    pageBuilder: (context, animation, secondaryAnimation) => CAMQuestion3Screen(),
