...
import 'package:flutter_app/Screens/Questionairres/general/social_history/question1_screen.dart';
      ...
      child: Column(
        ...
        children: <Widget>[
          ...
          Padding(
            ...
            child: MainSection(size: size, text: "Any abnormal bleeding PV?", image: "assets/images/gynaecology.png"),
          ),
...
Route _question1Route() {
  return PageRouteBuilder(
    pageBuilder: (context, animation, secondaryAnimation) => SocialHistoryQuestion1Screen(),
