      ...
      child: Column(
        ...
        children: <Widget>[
          ...
          Padding(
            ...
            child: MainSection(size: size, text: "Are you breast-feeding?", image: "assets/images/gynaecology.png"),
          ),
...
Route _question3Route() {
  return PageRouteBuilder(
    pageBuilder: (context, animation, secondaryAnimation) => WomenQuestion3Screen(),
