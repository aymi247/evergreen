      ...
      child: Column(
        ...
        children: <Widget>[
          ...
          Padding(
            ...
            child: MainSection(size: size, text: "Any breast lumps?", image: "assets/images/gynaecology.png"),
          ),
...
Route _question4Route() {
  return PageRouteBuilder(
    pageBuilder: (context, animation, secondaryAnimation) => WomenQuestion4Screen(),
