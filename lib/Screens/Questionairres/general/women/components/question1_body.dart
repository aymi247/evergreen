      ...
      child: Column(
        ...
        children: <Widget>[
          ...
          Padding(
            ...
            child: MainSection(size: size, text: "Are you pregnant?", image: "assets/images/gynaecology.png"),
          ),
...
Route _question2Route() {
  return PageRouteBuilder(
    pageBuilder: (context, animation, secondaryAnimation) => WomenQuestion2Screen(),
