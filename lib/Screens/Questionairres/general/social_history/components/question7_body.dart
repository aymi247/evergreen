      ...
      child: Column(
        ...
        children: <Widget>[
          ...
          Padding(
            ...
            child: MainSection(size: size, text: "How often do you eat out?", image: "assets/images/diet.jpg"),
          ),
...
Route _question8Route() {
  return PageRouteBuilder(
    pageBuilder: (context, animation, secondaryAnimation) => SocialHistoryQuestion8Screen(),
