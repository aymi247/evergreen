      ...
      child: Column(
        ...
        children: <Widget>[
          ...
          Padding(
            ...
            child: MainSection(size: size, text: "Are you living alone?", image: "assets/images/living_room.jpg"),
          ),
...
Route _question2Route() {
  return PageRouteBuilder(
    pageBuilder: (context, animation, secondaryAnimation) => SocialHistoryQuestion2Screen(),
