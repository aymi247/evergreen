  ...
  Widget build(BuildContext context) {
    ...
    return Background(
      child: Column(
        ...
        children: <Widget>[
          Text(
            "WELCOME TO INTERVENTION FOR DIABETICS HYPERTENSTIVE PATIENTS & OTHER PATIENTS", 
            textAlign: TextAlign.center,
            style: TextStyle(fontWeight: FontWeight.bold, fontSize: 20,)
          ),
          MainSection(size: size, text: "This package will help you manage your health condition!", image: "assets/images/diabetes.png"),
