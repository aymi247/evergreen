  ...
  Widget build(BuildContext context) {
    ...
    return Background(
      child: Column(
        ...
        children: <Widget>[
          Text(
            "WELCOME TO EVIDENCE BASED LIFESTYLE MEDICINE", 
            textAlign: TextAlign.center,
            style: TextStyle(fontWeight: FontWeight.bold, fontSize: 20,)
          ),
          MainSection(size: size, text: "This package will help you manage stress and prevent the detrimental effect on your health!", image: "assets/images/lifestyle.png"),
