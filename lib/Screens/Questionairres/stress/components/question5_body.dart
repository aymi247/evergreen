...
import 'package:flutter_app/Screens/Questionairres/stress/question6_screen.dart';
  ...
  Widget build(BuildContext context) {
    ...
    return Background(
      child: Column(
        ...
        children: <Widget>[
          MainSection(size: size, text: "5. In the last month, how often have you felt that things were going your way?", image: "assets/images/stress.png"),
