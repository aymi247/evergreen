...
import 'package:flutter_app/Screens/Questionairres/stress/question3_screen.dart';
  ...
  Widget build(BuildContext context) {
    ...
    return Background(
      child: Column(
        ...
        children: <Widget>[
          MainSection(size: size, text: "2.	In the last month, how often have you felt that you were unable to control the important things in your life?", image: "assets/images/stress.png"),
