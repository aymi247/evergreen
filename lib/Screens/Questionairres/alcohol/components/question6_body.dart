...
import 'package:flutter_app/Screens/Questionairres/alcohol/question7_screen.dart';
  ...
  Widget build(BuildContext context) {
    ...
    return Background(
      child: Column(
        ...
        children: <Widget>[
          MainSection(size: size, text: "6.	During the past year, how often have you needed a drink in the morning to get yourself going after a heavy drinking session?", image: "assets/images/alcohol.png"),
